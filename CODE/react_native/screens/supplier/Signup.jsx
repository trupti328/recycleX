...
export default function CustSignup({ navigation }) {
    ...
    const validateInputs = () => {
        if (!firstName || !lastName || !mobileNumber || !password || !state || !city || !pincode) {
            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                ...
                <View style={styles.formGroup}>
                    ...
                    <View style={styles.radioContainer}>
                        <TouchableOpacity style={[styles.radioButton, supplierType === 'Individual' && styles.radioSelected]} onPress={() => setSupplierType('Individual')}>
                            <Text style={styles.radioText}>Individual</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.radioButton, supplierType === 'Organization' && styles.radioSelected]} onPress={() => setSupplierType('Organization')}>
                            <Text style={styles.radioText}>Organization</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={[styles.radioButton, supplierType === 'Government' && styles.radioSelected]} onPress={() => setSupplierType('Government')}>

...
export default function Home({ navigation }) {
    ...
    const imagesArray = [
        { name: "plastic.png", source: require("../../assets/recycled/plastic-granules.jpeg") },
        { name: "metal.png", source: require("../../assets/recycled/metal.png") },
        { name: "paper.png", source: require("../../assets/recycled/paper.png") },
        { name: "glass.jpg", source: require("../../assets/recycled/glass.jpg") },
        { name: "electrinics.jpg", source: require("../../assets/recycled/electrinics.jpg") },
        { name: "rubber.jpg", source: require("../../assets/recycled/rubber.jpg") },
        { name: "resins.png", source: require("../../assets/recycled/resins.png") },
        { name: "biodegradable.jpg", source: require("../../assets/recycled/biodegradable.jpg") }
    ];

    const getImageSource = (imageName) => {
        const imageObj = imagesArray.find(img => img.name === imageName);
        return imageObj ? imageObj.source : require("../../assets/images/resins.png");
    };
    ...
    const fetchRawMaterials = async () => {
        try {
            ...
            const response = await axios.get('http://172.18.0.1:5000/common/getAllRecyclingCategories', {
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('details', { item })}>
                        ...
                        <Text style={styles.cardText}>{item.rp_category_name}</Text>
                        <Text style={styles.cardText}>{item.category_description}</Text>
                        <Button title="Show Products" onPress={() => goToSubcategory(item.rp_category_id)} />
                    </TouchableOpacity>
                )}
            />

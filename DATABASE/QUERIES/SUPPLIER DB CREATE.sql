...
CREATE TABLE trashSubCategories (
    ...
    extra_col5 VARCHAR(255) DEFAULT NULL INVISIBLE,
    -- Foreign key 
    FOREIGN KEY (category_id) REFERENCES trashCategories(category_id) ON DELETE
    SET NULL
);
...
CREATE TABLE supplierOrders (
    ...
    -- Foreign key
    FOREIGN KEY (supplier_id) REFERENCES supplier(supplier_id),
    FOREIGN KEY (pickup_id) REFERENCES pickupAddress(pickup_id) ON DELETE
    SET NULL
);
...
CREATE TABLE supplierOrderItems (
    ...
    FOREIGN KEY (subcategory_id) REFERENCES trashSubCategories(subcategory_id) ON DELETE
    SET NULL
);
